...
CREATE TABLE `phancong` (
  ...
  `Ghichu` text,
  `FK_MaNV` char(6) DEFAULT NULL,
  `FK_MaDV` char(6) NOT NULL,
  PRIMARY KEY (`Thoigian`,`FK_MaDV`),
  KEY `FK_MaNV_idx` (`FK_MaNV`),
  KEY `FK_MaDV_idx` (`FK_MaDV`)
...
-- Dump completed on 2018-06-14  1:50:23
