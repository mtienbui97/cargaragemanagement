...
namespace DAO
{
    public class MySqlDataAccessHelper
    {
        ...
        public static String ConnectionString
        {
            set
            {
                connectionString = "server=localhost;user id=root;database=quanlygarageoto;password=3725141531;persistsecurityinfo=True";
            }
            get
            {
        ...
        public static DataTable ExecuteQuery(string query, List<MySqlParameter> parameters = null)
        {
            ...
            try
            {
                var connect = new MySqlConnection("server=localhost;user id=root;database=quanlygarageoto;password=3725141531;persistsecurityinfo=True");
                connect.Open();
